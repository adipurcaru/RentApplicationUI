...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit() {
    // this.userName = this.authService.getAccount().idToken.email;
    // this.fullName = this.authService.getAccount().idToken.family_name + " " + this.authService.getAccount().idToken.given_name;
    this.getCategories();
